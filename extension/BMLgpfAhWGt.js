...
(function(a) {
    ...
    $ = a.Env || {};
    var r = $.profile_require_factories != null ? $.profile_require_factories : !1, s = a.performance || a.msPerformance || a.webkitPerformance || {}, t;
    ...
    function y(b) {
        ...
        if (b.factoryLength === -1) {
            var d = r ? a.ProfilingCounters : null;
            if (d) {
    ...
    function z(c) {
        ...
        if (o.call(k) === "[object Function]") {
                    ...
                    if (r) {
                        ...
                        if (k.__SMmeta)
                            for (var H in k.__SMmeta)
                                Object.prototype.hasOwnProperty.call(k.__SMmeta, H) && (g[H] = k.__SMmeta[H])
                    }
                }
            } catch (a) {
                f.hasError = !0;
            ...
            if (typeof f.exports === "function") {
                C = f.exports;
                w = C.__superConstructor__;
                (!C.displayName || w && w.displayName === C.displayName) && (C.displayName = (C.name || "(anonymous)") + " [from " + c + "]")
            }
            f.factoryFinished = !0
        } else
            f.exports = k;
...
__d("ErrorSerializer", [], (function(a, b, c, d, e, f) {
    ...
    function b(a, b) {
        ...
        var c = h(a.message)
          , d = b.forcedKey
          , e = c.forcedKey;
        d = d != null && e != null ? d + "_" + e : (d = d) != null ? d : e;
        return g({
            forcedKey: d,
            message: b.message + " from %s: %s",
            params: [].concat((e = b.params) != null ? e : [], [a.name, i(c)]),
...
__d("ErrorNormalizeUtils", ["ErrorSerializer", "FBLoggerMetadata"], (function(a, b, c, d, e, f) {
    ...
    function u(c, d) {
        ...
        var r = c.fbloggerMetadata ? c.fbloggerMetadata : []
          , v = b("FBLoggerMetadata").getGlobalMetadata().map(function(a) {
            return a.join(":")
        });
        r = [].concat(r, v);
        r.length === 0 && (r = void 0);
        v = c.messageWithParams;
        v != null && v.length > 0 ? v = {
            message: v[0],
            params: v.slice(1).map(function(a) {
                return String(a)
            })
        } : (typeof e !== "string" && (e = String(e) + " (" + typeof e + ")"),
        v = b("ErrorSerializer").parse(e));
        v = {
            column: i ? m(f) : l(c) || m(f),
            deferredSource: c.deferredSource != null ? u(c.deferredSource) : null,
            ...
            message: b("ErrorSerializer").toFormattedMessage(v),
            messageWithParams: b("ErrorSerializer").toMessageWithParams(v),
            ...
            stackFrames: f,
            type: (r = d == null ? void 0 : d.type) != null ? r : c.type || "error"
        };
        e = a.location;
        e && (v.windowLocationURL = e.href);
        for (var w in v)
            v[w] == null && delete v[w];
        return v
    }
      ...
      , n = {
        ...
        onerror: function(a, b, c, d, e) {
            ...
            if (e != null) {
                var f;
                e = e;
                e.fileName = (f = e.fileName) != null ? f : b;
                e.line = (f = e.line) != null ? f : c;
                e.column = (f = e.column) != null ? f : d
            } else
                e = new Error(a || ""),
                e.fileName = b,
                e.line = c,
...
__d("FBLogMessage", ["ErrorNormalizeUtils", "ErrorPubSub", "ErrorSerializer", "FBLoggerMetadata", "TAALOpcodes"], (function(a, b, c, d, e, f) {
    ...
    a = function() {
        ...
        c.$1 = function(c, d) {
            __p && __p();
            for (var e = arguments.length, f = new Array(e > 2 ? e - 2 : 0), h = 2; h < e; h++)
                f[h - 2] = arguments[h];
            var i = this.error, j = this.project, k = this.metadata, l = this.forcedKey, m;
            if (this.normalizedError) {
                ...
                m = Object.assign({}, this.normalizedError, {
                    message: b("ErrorSerializer").toFormattedMessage(n),
                    messageWithParams: b("ErrorSerializer").toMessageWithParams(n),
                    project: j,
                    type: c
                })
            } else if (i) {
                ...
                var o = b("ErrorSerializer").aggregateError(i, {
                    message: d,
                    params: f,
                    forcedKey: l
                });
                m = b("ErrorNormalizeUtils").normalizeError(i, {
                    message: o,
                    name: i.name,
                    project: j,
                    type: c
            ...
            k.isEmpty() || (m.fbloggerMetadata = k.formatMetadata());
...
__d("unrecoverableViolation", ["ErrorSerializer", "FBLogger", "TAAL"], (function(a, b, c, d, e, f) {
    "use strict";
    __p && __p();
    function a(a, c, d) {
        d = d === void 0 ? {} : d;
        ...
        var e = a;
        d && (c = c.catching(d),
        e = b("ErrorSerializer").aggregateError(d, {
            message: a
        }));
        c.blameToPreviousFrame().mustfix(a);
        throw new Error(b("TAAL").blameToPreviousFrame(e))
    }
    e.exports = a
}
), null);
...
__d("ArtilleryRequestDataCollector", ["Env", "FBLogger", "Heartbeat", "ProfilingCounters", "ProfilingCountersStore", "TimeSlice", "requireWeak"], (function(a, b, c, d, e, f) {
    "use strict";
    __p && __p();
    var g, h, i;
...
__d("ErrorGuard", ["Env", "ErrorNormalizeUtils", "ErrorPubSub"], (function(a, b, c, d, e, f) {
    "use strict";
    __p && __p();
    var g, h, i = "<anonymous guard>", j = /\bnocatch\b/.test(location.search);
    b("ErrorNormalizeUtils");
    g || (g = b("ErrorPubSub"));
    var k = {
        applyWithGuard: function(a, c, d, e) {
            __p && __p();
            (g || (g = b("ErrorPubSub"))).pushGuard((e == null ? void 0 : e.name) || (a.name ? "func_name:" + a.name : null) || i);
            (h || (h = b("Env"))).nocatch && (j = !0);
            if (j) {
                var f;
                try {
                    f = a.apply(c, d)
            ...
            try {
                ...
                e && (k.deferredSource = e);
                e = k.type;
                e = b("ErrorNormalizeUtils").normalizeError(k, {
                    project: "ErrorGuard",
                    type: e != null && e != "" ? e : "fatal"
                });
                ...
                e.guard = (g || (g = b("ErrorPubSub"))).guardList[0];
                e.guardList = g.guardList.slice();
                f && f(k);
                c && c(e);
                g.reportNormalizedError(e)
            } finally {
                (g || (g = b("ErrorPubSub"))).popGuard()
            }
        },
            ...
            if ((h || (h = b("Env"))).isCQuick) {
                ...
                a = function() {
                    if (b("MessengerEnvironment").messengerui && e.getPath().startsWith("/messages"))
                        return [!1, "/messages"];
                    if (d.getPath().startsWith("/settings") && e.getPath().startsWith("/settings"))
                        return [!1, "/settings"];
            ...
            if (!f) {
                ...
                for (var l = 0; l < g.length - 1; l++) {
                    ...
                    if (m) {
                        ...
                        g[l + 1] && !g[l + 1].match(/^\d{1,3}$/) ? k.push({}) : k.push([]),
                        k = k[k.length - 1]
                }
                k instanceof Array && g[g.length - 1] === "" ? k.push(f) : k[i(g[g.length - 1])] = f
            }
        }
        return b
    }
...
__d("URIBase", ["invariant", "URIRFC3986", "URISchemes", "ex", "isInternalFBURI", "setHostSubdomain"], (function(a, b, c, d, e, f, g) {
    __p && __p();
...
__d("URI", ["Env", "PHPQuerySerializer", "PHPQuerySerializerNoEncoding", "ReloadPage", "URIBase", "areSameOrigin", "ifRequired", "isFacebookURI", "isUriNeedRawQuerySVURI", "memoize", "memoizeStringOnly", "unqualifyURI", "FBLogger"], (function(a, b, c, d, e, f) {
    __p && __p();
    ...
    var m = function(d) {
        ...
        e.isSameOrigin = function(a) {
            a = a;
            a == null ? a = k() : a instanceof c || (a = new c(a.toString()));
        ...
        c.goURIOnWindow = function(d, e, f, g) {
            ...
            f = f;
            var h = !e || e === window;
            if ((i || (i = b("Env"))).isCQuick && b("isFacebookURI")(d) && h) {
                h = {};
                h.cquick = (i || (i = b("Env"))).iframeKey;
                h.ctarget = i.iframeTarget;
                h.cquick_token = i.iframeToken;
                d.addQueryData(h);
                f = !1
            }
            h = d.toString();
    ...
    a = function() {
        ...
        c.getLookasideURI = function() {
            var a = "origincache.facebook.com"
              , c = b("gkx")("996939");
            c ? b("gkx")("996940") && (a = "lookaside.internmc.facebook.com") : b("gkx")("676940") && (a = "lookaside.internmc.facebook.com");
...
__d("NetworkStatusImpl", ["FBLogger", "XHeartbeatController", "clearTimeout", "performance", "performanceNow", "setTimeout"], (function(a, b, c, d, e, f) {
    "use strict";
    __p && __p();
    var g, h, i = [], j = window.navigator.onLine, k = .5, l = 5e3, m = [];
    b("XHeartbeatController").getURIBuilder().getURI();
    f = 1e3;
    c = 100;
    var n = null;
    d = 0;
...
__d("JSResourceReference", ["Promise", "PromiseAnnotate", "ifRequired"], (function(a, b, c, d, e, f) {
    __p && __p();
    var g = function(a) {
        return a
    }
        ...
        c.load = function() {
            var a = this
              , c = new (b("Promise"))(function(b) {
                j(function(c) {
                    return c.loadModules([a.$1], b, a.$2 || "JSResource: unknown caller")
                })
            }
            );
...
__d("Bootloader", ["invariant", "nullthrows", "requireCond", "Arbiter", "BootloaderConfig", "BootloaderEndpoint", "CallbackDependencyManager", "CSRBitMap", "CSSLoader", "ErrorPubSub", "FBLogger", "JSResourceReference", "cr:696703", "NetworkStatus", "ResourceHasher", "ResourceTimingsStore", "TAAL", "TimeSlice", "createTrustedScriptURLFromFacebookURI", "ex", "ifRequired", "performanceAbsoluteNow", "setImmediateAcrossTransitions"], (function(a, b, c, d, e, f, g) {
    "use strict";
    __p && __p();
    var h, i, j = function() {}, k = [], l = [], m = new Set(), n = new Set(), o = new Map(), p = new Map(), q = new Map(), r = null, s = new Map(), t = new Map(), u = new Map(), v = new Map(), w = new Set(), x = new Map(), y = [], z = new Map(), A = new Map(), B = !1, C = new Set(), D = !1, E = new (b("CallbackDependencyManager"))(), F = new (b("Arbiter"))(), G = null, H = null, I = b("BootloaderConfig").jsRetries || [], J = b("BootloaderConfig").jsRetryAbortNum, aa = b("BootloaderConfig").jsRetryAbortTime, K = I.length > 0, L = Object.freeze({
        BOOTLOAD: "bootloader/bootload"
    });
    (h || (h = b("ErrorPubSub"))).unshiftListener(function(a) {
        a.loadingUrls = Array.from(u.keys())
    });
    function M(a) {
        __p && __p();
    ...
    function R(a, b, c, d, e) {
        ...
        e && (f.onload = e);
        c != null && !O(c).nc && (f.crossOrigin = "anonymous");
        d.appendChild(f)
    }
    function S(a, c, d, e) {
    ...
    function T(a, c) {
        __p && __p();
        var d = b("ResourceHasher").createAsyncHash();
        if (b("BootloaderConfig").shouldCoalesceModuleRequestsMadeInSameTick)
            if (H == null)
                H = {
                    key: d,
                    blockingComps: [].concat(a),
                    nonblockingComps: [].concat(c)
                },
                Z(d, a, c);
            else {
                var e;
                d = H.key;
                (e = H.blockingComps).push.apply(e, a);
                (e = H.nonblockingComps).push.apply(e, c);
                Z(d, H.blockingComps, H.nonblockingComps)
            }
        else
            Z(d, a, c);
        e = [].concat(a, c);
    ...
    function ba(a, c, d) {
        b("BootloaderConfig").trackUnpredictedBEResources && q.set(a, ca(d)),
        $.done(a, c)
    }
    function ca(a) {
        __p && __p();
        ...
        for (var b = b, d = Array.isArray(b), e = 0, b = d ? b : b[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
            ...
            g = g;
            g = N(g);
            g = [g.r, ((f = g.rds) == null ? void 0 : f.r) || [], ((f = g.rdfds) == null ? void 0 : f.r) || []];
            for (var f = 0; f < g.length; f++) {
                var h = g[f];
                for (var h = X(h), i = Array.isArray(h), j = 0, h = i ? h : h[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
                    var k;
                    if (i) {
                        if (j >= h.length)
                            break;
        ...
        k = 0;
        for (var l = X(a), j = Array.isArray(l), i = 0, l = j ? l : l[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
            if (j) {
                if (i >= l.length)
                    break;
                h = l[i++]
    ...
    function da(a, c, d) {
        ...
        a.onload = g.bind(void 0, function() {
            var a = x.get(e);
            a && b("FBLogger")("bootloader").info("JS retry success [%s] at %s | time: %s | retries: %s", c, e, (i || (i = b("performanceAbsoluteNow")))() - f, a);
        ...
        a.onerror = g.bind(void 0, function() {
            var g;
            b("ResourceTimingsStore").measureResponseReceived("js", h);
            g = (g = x.get(e)) != null ? g : 0;
            Q() && g < I.length ? (y.push((i || (i = b("performanceAbsoluteNow")))()),
            setTimeout(function() {
                if (!Q())
                    return;
                var b = a.parentNode;
            ...
            x.set(e, g + 1)) : (w.add(e),
            b("FBLogger")("bootloader").warn("JS loading error [%s] at %s | time: %s | retries: %s | concurrency: %s", c, e, (i || (i = b("performanceAbsoluteNow")))() - f, g, u.size),
            b("NetworkStatus").reportError(),
            d())
        })
    }
    function ea(a, c, d) {
        return function() {
            b("FBLogger")("bootloader").warn("CSS timeout [%s] at %s | concurrency: %s", a, c, u.size),
            w.add(c),
            b("NetworkStatus").reportError(),
            d()
        }
        ...
        if (c === ((d = H) == null ? void 0 : d.key)) {
            ...
            G = b("setImmediateAcrossTransitions")(function() {
                ...
                return e(function() {
                    ...
                    d != null || g(0, 12736, c);
                    H = null;
                    u.set(d, (i || (i = b("performanceAbsoluteNow")))());
                    b("BootloaderEndpoint").load($, d, function(a) {
                        return ba(c, d, a)
                    })
                })
            })
            ...
            b("BootloaderEndpoint").load($, a, function(b) {
                return ba(c, a, b)
            })
    }
    function ga(a, c, d, e) {
        ...
        u.set(c, (i || (i = b("performanceAbsoluteNow")))());
        if (a === "js")
            S(c, d, f, e);
        else if (a === "css") {
            if (d == null) {
            ...
            b("CSSLoader").loadStyleSheet(d, c, e, !O(d).nc, f, ea(d, c, f))
        }
    }
    function U(c, d, e, f) {
        __p && __p();
        var h = new Map()
          ...
          , l = []
          , n = []
          , o = window.CavalryLogger && window.CavalryLogger.getInstance();
        for (var c = X(c), p = Array.isArray(c), r = 0, c = p ? c : c[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
            var s;
            if (p) {
                if (r >= c.length)
                    break;
            ...
            s = s[1];
            var u = s.type;
            s.nonblocking && !b("BootloaderConfig").assumeNotNonblocking ? k.add(t) : ((u === "async" ? l : n).push(t),
            j.add(t));
            m.has(t) || (m.add(t),
            h.set(t, s),
            o && o.measureResources({
                name: t,
                type: u
            }, e))
        }
        ...
        s = [];
        if (f) {
            var x = (i || (i = b("performanceAbsoluteNow")))()
              , y = {
                async_resource_duration: null,
                static_resource_download_duration: null
            };
            if (l.length !== 0) {
                var z = "asyncTime:" + f.request_key;
                s.push(z);
                E.registerCallback(function() {
                    y.async_resource_duration = Math.round((i || (i = b("performanceAbsoluteNow")))() - x),
                    E.satisfyPersistentDependency(z)
                }, l)
            }
            if (n.length !== 0) {
                var A = "nonAsyncTime:" + f.request_key;
                s.push(A);
                E.registerCallback(function() {
                    y.static_resource_download_duration = Math.round((i || (i = b("performanceAbsoluteNow")))() - x),
                    E.satisfyPersistentDependency(A)
                }, n)
            }
            t = b("ifRequired")("CometInteractionTracingMetrics", function(a) {
                return a
            });
            var B;
            t && (B = t.currentInteractionLogger());
            v = function() {
                __p && __p();
                var a = Math.round((i || (i = b("performanceAbsoluteNow")))() - x)
                  , c = j.size
                  , d = Array.from(h.keys());
                d = {
                    blocking_resources_downloaded: d.filter(function(a) {
                        return j.has(a)
                    }).length,
                    blocking_resources_count: c,
                    all_resources_downloaded: d.length,
                    all_resources_count: c + k.size,
                    unpredicted_be_resources: b("BootloaderConfig").trackUnpredictedBEResources ? l.reduce(function(a, c) {
                        return a + b("nullthrows")(q.get(c))
                    }, 0) : null,
                    err_count: Array.from(h.values()).filter(function(a) {
                        a = a.src;
                        return w.has(a)
                    }).length
                };
                c = b("TimeSlice").getContext();
                c = babelHelpers["extends"]({}, f, d, y, {
                    timeslice_context: c && c.name,
                    start_time: x,
                    duration: a
                });
                if (B && f != null && f.components != null) {
                    var e = f.components;
                    B.addBootload(e, x, a, d.all_resources_downloaded)
                }
                delete c.request_key;
                F.inform(L.BOOTLOAD, c, "persistent")
            }
        }
        r = d ? function() {
            return d(v)
        ...
        : v;
        if (b("cr:696703") && r) {
            var C = b("cr:696703").getCallbackScheduler()
              , D = r;
            r = function() {
                C(D)
            }
        } else if (a.ScheduleJSWork && r) {
            var G = r;
            r = function() {
                a.ScheduleJSWork(G)()
            }
        ...
        if (r) {
            p = Array.from(j).concat(s);
            E.registerCallback(r, p)
        }
        c = document.createDocumentFragment();
        for (var o = h, e = Array.isArray(o), n = 0, o = e ? o : o[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
            if (e) {
                if (n >= o.length)
                    break;
                t = o[n++]
            ...
            t = p.src;
            u !== "csr" || g(0, 19455, t);
            u === "async" ? fa(t, r) : (R(t, u, r, c),
            ga(u, t, r, c))
        }
        P().appendChild(c)
    }
    function V(a) {
        a.substr(0, 1) === ":" || g(0, 19106, a);
    ...
    function W(a, c, d) {
        ...
        if (e) {
            ...
            for (var c = V(e), e = Array.isArray(c), f = 0, c = e ? c : c[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
                var h;
                if (e) {
                    if (f >= c.length)
                        break;
    ...
    function Y(a) {
        ...
        s.has(e) && !b("BootloaderConfig").silentDups && b("FBLogger")("bootloader").warn("Duplicate resource [%s]: %s", e, f.src);
        W(e, f, !0);
        var g = function() {
            return $.done(e)
        };
        c = d ? !a.getAttribute("async") : ((c = a.parentNode) == null ? void 0 : c.tagName) === "HEAD";
        c || window._btldr && window._btldr[e] ? g() : (m.add(e),
        d ? da(a, e, g) : b("CSSLoader").setupEventListeners(e, f.src, P(), g, ea(e, f.src, g), a))
    }
    function ha() {
        if (B)
            return;
    ...
    function Z(a, c, d) {
        s.set(a, {
            src: b("BootloaderEndpoint").getURL(c, d, b("BootloaderConfig").payloadEndpointURI),
            type: "async"
        })
    }
    function ia(a, b) {
        ...
        for (var a = X(a), c = Array.isArray(a), d = 0, a = c ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
            ...
            if (m.has(f))
                continue;
            e.type === "async" ? (m.add(f),
            fa(e.src, f)) : R(e.src, e.type, f, b)
        }
    }
    var $ = {
        preloadModules: function(a) {
            ...
            for (var a = a, f = Array.isArray(a), g = 0, a = f ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
                ...
                var i = N(h)
                  ...
                  , l = i.rdfds;
                i = i.be;
                b("BootloaderConfig").preloadBE && !b("ifRequired").call(null, h, function() {
                    return !0
                }, function() {
                    return !1
                }) && !p.get(h) && (i ? d : e).push(h);
                i = [j, (l == null ? void 0 : l.r) || []];
        ...
        loadModules: function(a, c, e) {
            ...
            var r = []
              ...
              , u = !1
              , v = 0
              , w = (i || (i = b("performanceAbsoluteNow")))();
            a.forEach(function(a) {
                __p && __p();
                var c = N(a)
                  , d = c.r
                ...
                c = c.be;
                c && v++;
                if (!b("ifRequired").call(null, a, function() {
                    return !0
                }, function() {
                    return !1
                })) {
                    var g = p.get(a);
                    g ? c && k.push(g) : (c ? r : t).push(a)
                }
                z.has(a) || (u = !0,
                z.set(a, w));
                k.push.apply(k, d);
                m.push.apply(m, (e == null ? void 0 : e.r) || []);
                n.push.apply(n, (f == null ? void 0 : f.r) || []);
                o.push.apply(o, (e == null ? void 0 : e.m) || []);
                q.push.apply(q, (f == null ? void 0 : f.m) || [])
            });
            ...
            for (var C = 0; C < k.length; C++) {
                var D = k[C];
                s.has(D) || b("FBLogger")("bootloader").mustfix("Missing rsrc %s when bootloading %s", D, x)
            }
            U(k, function(b) {
                return d.call(null, a, function() {
                    b && b(),
                    f.apply(void 0, arguments),
                    E.satisfyPersistentDependency(B)
                })
            }, null, y);
            var F = "rdfds:" + x;
            U(m, function() {
                E.registerCallback(d.bind(null, o, function() {
                    E.satisfyPersistentDependency(F)
                }), [B])
            });
            U(n, function() {
                E.registerCallback(d.bind(null, q, j), [F])
            });
            U(h);
            return g
        },
        loadResources: function(a, c, d) {
            ...
            for (var a = a, f = Array.isArray(a), g = 0, a = f ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
                ...
                h = h;
                e.push(b("ResourceHasher").getValidResourceHash(h))
            }
            U(e, c, d)
        },
        requestJSResource_UNSAFE_NEEDS_REVIEW_BY_SECURITY_AND_XFN: function(a) {
            ...
            if (c != null) {
                var d;
                d = (d = u.get(c)) != null ? d : NaN;
                v.set(c, (i || (i = b("performanceAbsoluteNow")))() - d);
                u["delete"](c)
            }
            if (a != null) {
                window.CavalryLogger && window.CavalryLogger.done_js([a]);
                d = b("ResourceHasher").getValidResourceHash(a);
                m.add(d);
                E.satisfyPersistentDependency(d)
            }
        },
        ...
        setResourceMap: function(a, c) {
            ...
            if (c)
                for (var e = c, a = Array.isArray(e), c = 0, e = a ? e : e[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
                    var f;
                    if (a) {
                        if (c >= e.length)
                            break;
            ...
            if (f.__m)
                ...
                d.call(null, [f.__deferredElement], function(a) {
                    ...
                    k.length && (k.forEach((g || (g = b("ErrorGuard"))).guard(function(b) {
                        ...
                        name: "JS::deferredElement callback: '" + f.__deferredElement + "'"
                    })),
                    k.length = 0)
                });
                j = {
...
__d("ServerJS", ["ContextualComponent", "ErrorGuard", "ServerJSDefine", "ex", "ge", "replaceTransportMarkers", "__debug"], (function(a, b, c, d, e, f) {
    ...
    a = function() {
        ...
        c.$12 = function(a, c, d, e) {
            ...
            .bind(this), {
                name: m != null ? "JS::call('" + f + "', '" + m + "', ...)" : "JS::requireModule('" + f + "')"
            });
...
__d("BootloaderEndpoint", ["ix", "CSRFGuard", "FBLogger", "ServerJS", "TimeSlice", "bx", "getAsyncParams", "getSameOriginTransport", "gkx", "objectEntries", "qex"], (function(a, b, c, d, e, f, g) {
    "use strict";
    __p && __p();
    function h(a, c, d, e) {
        __p && __p();
        ...
        c = d.resource_map;
        f = d.bootloadable;
        var l = d.allResources;
        c && a.setResourceMap(c);
        f && a.enableBootload(f);
        a.loadResources(a.getCSSResources(l || []), function() {
            new (b("ServerJS"))().handle(k || {}),
            e({
                allResources: l || [],
                modules: j || []
            })
    ...
    a = {
        getURL: function(a, c, d) {
            a = {
                modules: a,
                nb_modules: c
            };
            c = b("objectEntries")(a).filter(function(a) {
                a[0];
                a = a[1];
                return a.length > 0
            }).map(function(a) {
                var b = a[0];
                a = a[1];
                return b + "=" + encodeURIComponent(a.join(","))
            }).join("&");
...
__d("getAsyncParams", ["CSRBitMap", "CurrentCommunity", "CurrentUserInitialData", "DTSG", "DTSG_ASYNC", "DTSGUtils", "Env", "ISB", "LSD", "ServerJSDefine", "SiteData", "SprinkleConfig", "StaticSiteData", "WebSession", "asyncParams", "isSocialPlugin"], (function(a, b, c, d, e, f) {
    ...
    function a(a) {
        ...
        requestHeaderObject = JSON.parse(JSON.stringify(c));
        if (a == "POST") {
...
__d("BigPipe", ["ix", "requireDeferred", "Arbiter", "BigPipeExperiments", "BigPipeInstance", "BigPipePlugins", "Bootloader", "ErrorUtils", "FBLogger", "JSCC", "PageEvents", "PageletEventConstsJS", "PageletSet", "RunBlue", "ServerJS", "TimeSlice", "UserTimingUtils", "$", "bx", "captureUsageSnapshot", "clearTimeout", "fastDeepCopy", "ge", "gkx", "performanceAbsoluteNow", "qex", "requestAnimationFrame", "setTimeout", "__getTotalFactories", "__getCompileTime", "__getFactoryTime"], (function(a, b, c, d, e, f, g) {
    __p && __p();
    ...
    Object.assign(a.prototype, {
        ...
        onPageletArrive: (h || (h = b("ErrorUtils"))).guard(function(a) {
            ...
            a.bxData && b("bx").add(a.bxData);
            a.gkxData && b("gkx").add(a.gkxData);
            a.ixData && g.add(a.ixData);
            a.qexData && b("qex").add(a.qexData);
...
__d("TimeSliceInteraction", ["invariant", "Arbiter", "ArtilleryComponentSaverOptionsStatic", "ArtilleryTraceIDUtils", "Bootloader", "CircularBuffer", "ErrorUtils", "FBLogger", "Heartbeat", "InteractionAsyncRequestJoinDataSource", "ProfilingCounters", "ProfilingCountersStore", "Random", "ResourceTimingsStore", "ResourceTypes", "TimeSlice", "TimeSliceExecutionDataSource", "TimeSliceInteractionBootloadForPost", "TimeSliceInteractionReliability", "TimeSliceInteractionSV", "TimingAnnotations", "TSIAdsReliabilityHook", "Visibility", "compactArray", "nullthrows", "performance", "performanceAbsoluteNow", "performanceNavigationStart", "requestIdleCallbackAcrossTransitions", "requireWeak"], (function(a, b, c, d, e, f, g) {
    ...
    d = 250;
    var n = new (b("CircularBuffer"))(d);
    new Map();
    f = 100;
    var o = new (b("CircularBuffer"))(f)
      , p = new Map()
      , q = !1
      , r = null;
    ...
    var s = new (b("TimingAnnotations").EmptyTimingAnnotations)()
      , t = new (b("TimingAnnotations").EmptyTraceTimingAnnotations)()
    ...
    function y(a) {
        ...
        x(a) ? e = 1 : e = Object.prototype.hasOwnProperty.call(c, a) ? c[a] : b("TimeSliceInteractionSV").default_rate;
    ...
    var C = function() {
        ...
        function c(a, c, d) {
            ...
            this.$12 = [];
            this.$13 = [];
            this.$14 = new (b("TimingAnnotations").TraceTimingAnnotations)();
            this.$15 = new Map();
            this.$18 = null;
            this.$19 = 1;
            this.$22 = 1;
            ...
            this.$20 = k;
            this.$21 = f;
            this.$17 = d ? b("performanceNavigationStart")() : (i || (i = b("performanceAbsoluteNow")))();
            this.$25 = new Map();
            this.$9 = new Set();
            ...
            w(this);
            p.set(this, []);
            this.isEnabledForMode("full") && (b("TimeSliceInteractionSV").enable_heartbeat && (this.$5 = b("Heartbeat").get().expressInterest()),
            ...
            if (g.size === 0)
                ...
                if (this.isEnabledForMode("full")) {
                    ...
                    this.$12.push(f);
                    x(a) && (r = b("nullthrows")(this.$3),
                    q = !1);
                    this.$23 = (h || (h = b("ProfilingCountersStore"))).getInstance().open();
                    this.$24 = b("TimeSlice").getBuffer().open();
                ...
                var n = b("compactArray")(c.map(function(a) {
                    e.$22++;
                    return a.registerInteraction(m)
                }));
                this.$12.push(function() {
                ...
                this.$11.push(function() {
                    e.trace().addStringAnnotation("wait_for_count", "" + e.$22)
                })
            }
            for (var d = g, k = Array.isArray(d), f = 0, d = k ? d : d[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
                if (k) {
                    if (f >= d.length)
                        break;
                    c = d[f++]
        ...
        d.countDown = function() {
            this.$22--,
            this.$22 === 0 ? this.$18 && this.$18() : this.$22 < 0 && b("FBLogger")("TimeSliceInteraction").warn("some hook counted down twice")
        }
        ;
        d.countUp = function() {
            this.$22 > 0 ? ++this.$22 : b("FBLogger")("TimeSliceInteraction").warn("Attempting to countUp on finished interaction")
        }
        ;
        d.inform = function(a, c) {
            ...
            this.$10.push(babelHelpers["extends"]({
                ts: d,
                name: a,
                annotations: e,
                rawStackTrace: c && c.rawStackTrace || null,
        ...
        d.informPointWithOverride = function(a, c) {
            ...
            if (!this.isEnabledForMode("full") && !(this.isEnabledForMode("lite") && e) || !this.$27)
                return s;
            ...
            if (f)
                ...
                this.$27[a] = babelHelpers["extends"]({
                    ts: d,
                    name: a,
                    annotations: f,
                    rawStackTrace: c && c.rawStackTrace || null,
        ...
        d.finish = function(a) {
            __p && __p();
            var c = this;
            this.$28(a ? "client_tsi_finish_on_unload" : "client_tsi_finish");
            if (!this.$4)
                return;
            if (a && this.$18) {
                this.$18();
            ...
            if (this.$7)
                ...
                for (var d = this.$16, e = Array.isArray(d), f = 0, d = e ? d : d[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
                    var h;
                    if (e) {
                        if (f >= d.length)
                            break;
                ...
                k && this.trace().addStringAnnotation("weight", "" + 1 / (this.$19 * this.$20));
                j && this.trace().addStringAnnotation("lite_weight", "" + 1 / (this.$19 * this.$21));
                ...
                p["delete"](this);
                this.$5 && this.$5();
                var o = this.$23 != null ? this.$23.close() : []
                  , q = this.$24 != null ? this.$24.close() : []
                  , s = this.$24 != null ? this.$24.hasOverflown() : !1
                  , t = this.$24 != null ? this.$24.getOverflowSize() : 0;
                if (j || k) {
                    var u = function(a) {
                        j && c.$29(n),
                        k && c.$30(m, n, a, o, q, s, t),
                        r && r === c.$3 && (b("Arbiter").inform("time_slice_trace_posted", {
                            traceId: c.$3
                        }),
                        r = null),
                        c.$31()
        ...
        d.disable = function(a) {
            ...
            if (!a && this.$4)
                for (var a = this.$16, c = Array.isArray(a), d = 0, a = c ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); ; ) {
                    var e;
                    if (c) {
                        if (d >= a.length)
                            break;
        ...
        d.receiveAsyncResponse = function(a) {
            a != null && a.artillery_info && this.isEnabledForMode("full") ? this.$32(a.artillery_info.artillery_join_points) : this.disable();
            return this
        }
        ;
        ...
        d.$29 = function(a) {
            ...
            if (!this.isEnabled())
                return;
            var d = [];
            a = this.$10.concat(Object.values(this.$27)).concat(a || []);
            a.forEach(function(a) {
            ...
            var e = {
                trace_id: this.$3,
                action_name: this.$1,
                trace_annotations: this.$14.prepareToSend(),
                points: d
            };
            b("Bootloader").loadModules(["Banzai", "BanzaiODS", "PerfXSharedFields"], function(a, d, f) {
                ...
                a.post(v, f.addCommonValues(e), a.VITAL)
            }, "TimeSliceInteraction")
        }
        ;
        d.$30 = function(a, c, d, e, f, g, i) {
            __p && __p();
            var k = this;
            this.$28("client_tsi_post_start");
            this.$11.forEach(function(a) {
                return a()
            });
            this.$11 = [];
            if (!this.isEnabled())
                return;
            c = c != null ? this.$10.concat(c) : this.$10;
            c.push.apply(c, Object.values(this.$27));
            var l = c.map(A)
              , m = Array.from(this.$9.keys())
              , n = new Map(this.$25.entries());
            b("TimeSliceInteractionBootloadForPost")(function(c, o, p, q, r, s, t) {
                __p && __p();
                k.$28("client_tsi_post_ready");
                b("TimeSliceInteractionReliability").bumpLifecycleCounter("posting", k.$1, "full");
                p = r.getMetrics(k.$17, a, b("TimeSliceInteractionSV").maxBlockMergeDuration, b("TimeSliceInteractionSV").maxBlockMergeDistance, f, (h || (h = b("ProfilingCountersStore"))).toMap(e), {
                    includeRefTreeIDs: !0,
                    counterFunction: function(a) {
                        return B(m, a)
                    }
                });
                k.$14.addStringAnnotation("overflown_timeslice_buffer", g ? "1" : "0");
                k.$14.addStringAnnotation("overflown_timeslice_entry_count", "" + i);
                if ((j || (j = b("performance"))) && (j || (j = b("performance"))).timing && (j || (j = b("performance"))).timing.navigationStart) {
                    var v = f.length > 0 ? f[0].begin : null;
                    q = q.getMetrics(v != null && v < k.$17 ? v : k.$17, {}, null, a, !0, !0);
                    v = q.data;
                    q = q.diagnostics;
                    q && (k.$14.addStringAnnotation("number_of_valid_entries", q.numValidEntries.toString()),
                    k.$14.addStringAnnotation("number_of_success_metrics", q.numSuccessfulMetrics.toString()));
                ...
                q = {
                    ...
                    action_name: k.$1,
                    points: l,
                    traceAnnotations: k.$14.prepareToSend(),
                ...
                b("TimeSliceInteractionSV").compression_enabled && (q = k.$33(s, q));
                r = b("TimeSliceInteractionSV").banzai_stream_coinflip || 0;
                k.$26 && b("TimeSliceInteractionSV").enable_banzai_stream && b("Random").coinflip(r) ? o.post(u, q, {
                    compress: !1
                }) : c.post(u, q, {
                    compress: !1
                })
        ...
        d.$31 = function() {
            delete this.$10,
            this.$11 = [],
            this.$12 && (this.$12.forEach(function(a) {
                return a()
            }),
            this.$12 = []),
            this.$13 = [],
        ...
        d.isEnabledForMode = function(a) {
            return this.$4 && !this.$7 && this.$16.has(a)
        }
        ;
        d.isDone = function() {
            return this.$7
...
__d("Primer", ["invariant", "Bootloader", "CSS", "Env", "Event", "Parent", "PhotoSnowliftLoader", "PrimerInlineHandlers", "ReactServerPrimer", "TimeSlice", "clickRefAction", "firstClickTimestamp", "ifRequired", "performanceNow", "trackReferrer"], (function(a, b, c, d, e, f, g) {
    __p && __p();
    ...
    function l(a, c, d, e, f) {
        ...
        l = b("PrimerInlineHandlers").run(d, a, "data-onclick");
        b("trackReferrer")(c, m);
        var n = f || c.rel;
        n = n && n.match(k);
        n = n && n[0];
        ...
        case "async-post":
            ...
            break;
        case "theater":
            !(i || (i = b("Env"))).isCQuick ? b("PhotoSnowliftLoader").load(m, c, e) : b("ifRequired")("PageTransitions", function(a) {
                a.go(m)
            });
            break;
        case "toggle":
            j = c.parentNode;
            j != null || g(0, 2302);
            b("CSS").toggleClass(j, "openToggler");
...
__d("SidebarPrelude", ["Arbiter", "Bootloader", "ChatConfig", "CSS", "URI", "qex", "setTimeout"], (function(a, b, c, d, e, f) {
    __p && __p();
    var g, h = b("ChatConfig").get("sidebar.hide_buddylist_off_homepage"), i = b("ChatConfig").get("sidebar.hide_buddylist_off_allpage"), j = b("qex")._("1211266") || !1, k = "buddylistOff", l = "sidebarMode";
    a = {
        addSidebarMode: function(a) {
            var c = document.documentElement;
            if (c) {
                var d = i || j || h && !this.isOnHomepage();
                d ? b("CSS").addClass(c, k) : (b("CSS").removeClass(c, k),
                h && b("setTimeout")(function() {
                    b("Bootloader").loadModules(["Dock"], function(a) {
                        a.resizeAllFlyouts()
                    }, "SidebarPrelude")
                }));
                c.clientWidth > a && (b("CSS").addClass(c, l),
        ...
        addBuddylistMode: function() {
            ...
            if (a) {
                ...
                c ? b("CSS").addClass(a, k) : (b("CSS").removeClass(a, k),
                h && b("setTimeout")(function() {
                    b("Bootloader").loadModules(["Dock"], function(a) {
                        a.resizeAllFlyouts()
                    }, "SidebarPrelude")
...
__d("coinflip", [], (function(a, b, c, d, e, f) {
    function a(a) {
        return a != null && a >= 1 && (a === 1 || Math.random() * a < 1)
    }
    e.exports = a
}
), null);
...
__d("TimeSliceImpl", ["invariant", "CallStackExecutionObserver", "CircularBuffer", "Env", "ErrorGuard", "FBLogger", "IntervalTrackingBoundedBuffer", "WorkerUtils", "coinflip", "getReusableTimeSliceContinuation", "nullthrows", "performanceAbsoluteNow", "wrapFunction"], (function(a, b, c, d, e, f, g) {
    __p && __p();
    ...
    var L = {
        ...
        guard: function(a, c, d) {
            ...
            var k = {}
              , l = 0
              , p = void 0;
            (h || (h = b("Env"))).timeslice_heartbeat_config && (h || (h = b("Env"))).timeslice_heartbeat_config.isArtilleryOn && d && d.registerCallStack && b("coinflip")((h || (h = b("Env"))).deferred_stack_trace_rate) && (p = new Error("deferred execution source"));
            var q = {
                cancel: function() {
                    q.invoked || (i || (i = b("ErrorGuard"))).applyWithGuard(G, null, [c, k])
                },
                tokens: [],
                invoked: !1
            };
            d = function() {
                ...
                q.invoked || (q.invoked = !0,
                q.tokens.length && (q.tokens.forEach(function(a) {
                    delete s[a]
                }),
                q.tokens = []));
                E(h, k);
                if (f != null) {
                    var m = !!e.isContinuation;
                    f.isRoot ? (h.indirectParentID = f.contextID,
                    h.isEdgeContinuation = m) : (h.indirectParentID = f.indirectParentID,
                    h.isEdgeContinuation = !!(m && f.isEdgeContinuation))
                }
            ...
            ;
            d[m] = q;
            (i || (i = b("ErrorGuard"))).applyWithGuard(F, null, [k, c, e]);
            return d
        },
